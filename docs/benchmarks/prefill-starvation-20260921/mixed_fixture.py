...
def main() -> int:
    ...
    rec = {
        "raw_c1": {k:v for k,v in c1.items() if k != "first_event"},
        "raw_a": {k:v for k,v in a.items() if k != "first_event"},
        "raw_b": {k:v for k,v in b.items() if k != "first_event"},
        ...
        "c2_a_overlap_events_per_s": overlap_tok_s,
        ...
        "legacy_token_to_event_ratio_do_not_use": None
...
TASK = "\nExplain hash-map design in depth, including collision handling, resizing, concurrency and amortized analysis. Write at least 1500 words."
